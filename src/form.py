...
class Ui_MainBaseForm(object):
    def setupUi(self, MainBaseForm):
        ...
        MainBaseForm.resize(1015, 491)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        #sizePolicy.setHorizontstartalStretch(0)
        ...
        #elf.sample_list.setObjectName("sample_list")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.report_group_btn.sizePolicy().hasHeightForWidth())
        self.report_group_btn.setSizePolicy(sizePolicy)
        self.report_group_btn.setObjectName("report_group_btn")
        self.horizontalLayout_2.addWidget(self.report_group_btn)
        self.data_layout.addLayout(self.horizontalLayout_2)
    ...
    def retranslateUi(self, MainBaseForm):
        ...
        self.add_std_btn.setText(_translate("MainBaseForm", "Добавить Эталон"))
        ...
        self.add_sample_btn.setText(_translate("MainBaseForm", "Добавить Пациента"))
